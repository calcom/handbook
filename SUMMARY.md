...
* [👋 Cal.com Handbook](README.md)

## The Company

* [❓ What is Cal.com?](the-company/what-is-cal.com.md)
* [📈 Mission, Vision and Values](the-company/mission-vision-and-values.md)
* [🅰️ Glossary](the-company/glossary.md)
...
* [🏆 IC Levels](hr-and-careers/ic-levels/README.md)
  * [⛰️ Engineering Levels](hr-and-careers/ic-levels/engineering-levels/README.md)
    * [🕵️ IC1 Engineer (Code Cadet)](hr-and-careers/ic-levels/engineering-levels/ic1-engineer-code-cadet.md)
...
* [🏖️ Vacations](policies/vacations.md)
* [💳 Expenses](policies/expenses.md)
* [🗣️ Communications](policies/communications.md)
...
* [☑️ Self-reviews](engineering/self-reviews.md)
...
* [🎯 Best practices](engineering/best-practices/README.md)
  ...
  * [Prefer early returns](engineering/best-practices/prefer-early-returns.md)
  * [Avoid comparing multiple values with \`includes\`](engineering/best-practices/avoid-comparing-multiple-values-with-includes.md)
...
* [💻 Codebase](engineering/codebase/README.md)
  * [🔓 Keeping the lock file in sync](engineering/codebase/keeping-the-lock-file-in-sync.md)
  * [🚫 Git Private Submodules](engineering/codebase/git-private-submodules.md)
  * [🏎️ Monorepo / Turborepo](engineering/codebase/monorepo-turborepo.md)
  * [🌝 Deploying to Production](engineering/codebase/merging-monday.md)
  * [☁️ Deployment](engineering/codebase/deployment.md)
...
* [💟 Tone](customer-success/tone.md)

## Marketing

* [🎬 Media](marketing/media.md)
* [☝️ How to add a new Tip to Sidebar](marketing/how-to-add-a-new-tip-to-sidebar.md)

## 🤲 Sales

* [Operations Stack](sales/operations-stack.md)
